...
urlpatterns = patterns('',
    ...
    url(r'^accounts/auth/logout/$', 'proferater.views.logout'),
    url(r'^accounts/auth/loggedin/$', 'proferater.views.loggedin'),
    url(r'^accounts/auth/invalid/$', 'proferater.views.invalid_login'),
